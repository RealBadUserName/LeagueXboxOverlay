...
namespace __Interop
{
	...
	public unsafe static partial class kernel32_dll
	{
		...
		// Signature, CreateFileMappingFromApp, [fwd] [return] [EETypeRva:0x000434A4] Microsoft_Win32_SafeHandles_SafeMemoryMappedFileHandle__System_IO_MemoryMappedFiles____w64 int, [fwd] [in] [EETypeRva:0x000419B0] System_IntPtr____w64 int, [fwd] [in] [out] [managedbyref] [nativebyref] [EETypeRva:0x0004314C] __Interop_Kernel32_SECURITY_ATTRIBUTES__System_IO_MemoryMappedFiles____Interop_Kernel32_SECURITY_ATTRIBUTES__System_IO_MemoryMappedFiles, [fwd] [in] [EETypeRva:0x000419B0] int__int, [fwd] [in] [EETypeRva:0x000419B0] long____int64, [fwd] [in] [EETypeRva:0x00041B44] string__wchar_t *, 
		...
		// Signature, VirtualQuery, [fwd] [return] [EETypeRva:0x000419B0] System_UIntPtr____w64 unsigned int, [fwd] [in] [EETypeRva:0x000434A4] Microsoft_Win32_SafeHandles_SafeMemoryMappedViewHandle__System_IO_MemoryMappedFiles____w64 int, [fwd] [in] [out] [managedbyref] [nativebyref] [EETypeRva:0x0004314C] __Interop_Kernel32_MEMORY_BASIC_INFORMATION__System_IO_MemoryMappedFiles____Interop_Kernel32_MEMORY_BASIC_INFORMATION__System_IO_MemoryMappedFiles, [fwd] [in] [EETypeRva:0x000419B0] System_UIntPtr____w64 unsigned int, 
		...
		// Signature, GetSystemInfo, [fwd] [return] [EETypeRva:0x00041F6C] void__void, [fwd] [out] [managedbyref] [nativebyref] [EETypeRva:0x0004314C] __Interop_Kernel32_SYSTEM_INFO__System_IO_MemoryMappedFiles____Interop_Kernel32_SYSTEM_INFO__System_IO_MemoryMappedFiles, 
		...
		// Signature, MapViewOfFileFromApp, [fwd] [return] [EETypeRva:0x000434A4] Microsoft_Win32_SafeHandles_SafeMemoryMappedViewHandle__System_IO_MemoryMappedFiles____w64 int, [fwd] [in] [EETypeRva:0x000434A4] Microsoft_Win32_SafeHandles_SafeMemoryMappedFileHandle__System_IO_MemoryMappedFiles____w64 int, [fwd] [in] [EETypeRva:0x000419B0] int__int, [fwd] [in] [EETypeRva:0x000419B0] long____int64, [fwd] [in] [EETypeRva:0x000419B0] System_UIntPtr____w64 unsigned int, 
		...
		// Signature, FlushViewOfFile, [fwd] [return] [EETypeRva:0x00040848] bool__System.Boolean, [fwd] [in] [EETypeRva:0x000419B0] System_IntPtr____w64 int, [fwd] [in] [EETypeRva:0x000419B0] System_UIntPtr____w64 unsigned int, 
	...
	{
		// Signature, OpenFileMappingFromApp, [fwd] [return] [EETypeRva:0x000434A4] Microsoft_Win32_SafeHandles_SafeMemoryMappedFileHandle__System_IO_MemoryMappedFiles____w64 int, [fwd] [in] [EETypeRva:0x000419B0] int__int, [fwd] [in] [EETypeRva:0x00040848] bool__System.Boolean, [fwd] [in] [EETypeRva:0x00041B44] string__wchar_t *, 
		[global::System.Runtime.InteropServices.McgPInvokeMarshalStub("System.IO.MemoryMappedFiles, Version=4.1.1.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", "Interop+mincore", "OpenFileMappingFromApp")]
		public static global::Microsoft.Win32.SafeHandles.SafeMemoryMappedFileHandle__System_IO_MemoryMappedFiles OpenFileMappingFromApp(
					int DesiredAccess, 
					bool InheritHandle, 
					string Name)
		{
			...
			fixed (char* pinned_Name = Name)
			{
				...
				global::System.Runtime.InteropServices.McgMarshal.ClearLastWin32Error();
				// Call to native method
				unsafe___value = global::__Interop.api_ms_win_core_memory_l1_1_3_dll_PInvokes.OpenFileMappingFromApp(
									DesiredAccess, 
									(InheritHandle ? 1 : 0), 
									unsafe_Name
								);
		...
		// Signature, VirtualAllocFromApp, [fwd] [return] [EETypeRva:0x000419B0] System_IntPtr____w64 int, [fwd] [in] [EETypeRva:0x000434A4] System_Runtime_InteropServices_SafeHandle____w64 int, [fwd] [in] [EETypeRva:0x000419B0] System_UIntPtr____w64 unsigned int, [fwd] [in] [EETypeRva:0x000419B0] int__int, [fwd] [in] [EETypeRva:0x000419B0] int__int, 
	...
	public unsafe static partial class api_ms_win_core_memory_l1_1_3_dll_PInvokes
	{
		...
		public extern static global::System.IntPtr OpenFileMappingFromApp(
					int DesiredAccess, 
					int InheritHandle, 
					ushort* Name);
